            ...
            <div class='info'>
                <ul class='info-wrap'>
                    <li class='info-item info-left'>
                        <div class='info-num'>
                            {{ infoShow.finished.up }}
                            <span class='info-num-denominator'>/{{ infoShow.finished.down }}</span> 
                        </div>
                        <div class='info-name'>已完成</div>
                    </li>
                    <li class='divide-line'></li>
                    <li class='info-item info-middle'>
                        <div class='info-num'>
                            {{ infoShow.staffTarget.up }}
                            <span class='info-num-denominator'>/{{ infoShow.staffTarget.down }}</span>
                        </div>
                        <div class='info-name'>员工目标</div>
                    </li>
                    <li class='divide-line'></li>
                    <li class='info-item info-right'>
                        <div class='info-num'>
                            {{ infoShow.itemReach.up }}
                            <span class='info-num-denominator'>/{{ infoShow.itemReach.down }}</span> 
                        </div>
                        <div class='info-name'>项目达标</div>
                    </li>
                </ul>
            </div>
            <!-- 各销售部动作 -->
