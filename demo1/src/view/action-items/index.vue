            ...
            <div class='info'>
                <ul class='info-wrap'>
                    <li class='info-item info-left'>
                        <div class='info-num'>
                            {{ infoShow.actionItemNum.up }}
                            <span class='info-num-denominator'>/{{ infoShow.actionItemNum.down }}</span>
                        </div>
                        <div class='info-name'>动作项目数</div>
                    </li>
                    <li class='divide-line'></li>
                    <li class='info-item info-middle'>
                        <div class='info-num'>
                            {{ infoShow.averageActionItemNum }}
                        </div>
                        <div class='info-name'>人均动作项目数</div>
                    </li>
                    <li class='divide-line'></li>
                    <li class='info-item info-right'>
                        <div class='info-num'>
                            {{ infoShow.itemAverageAction }}
                        </div>
                        <div class='info-name'>项目平均动作</div>
                    </li>
                </ul>
            </div>
            <!-- 各销售部动作 -->
        ...
        data () {
            return {
                ...
                infoShow: {
                    ...
                    averageActionItemNum: 2,
                    itemAverageAction: 1.2
                },
            }
        },
        methods: {
